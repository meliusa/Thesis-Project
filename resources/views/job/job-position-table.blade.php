                ...
                <div id="kt_content_container" class="container-xxl">
                    ...
                    <div class="card">
                                                ...
                                                <form id="kt_modal_add_job_position_form" class="form"
                                                    ...
                                                    <div class="d-flex flex-column scroll-y me-n7 pe-7">
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <select name="id_divisi" aria-label="" data-control="select2" data-placeholder=""
                        ...
                        <div class="card-body py-4">
                            <!--begin::Table-->
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_datatable_position">
                                <!--begin::Table head-->
                                <thead>
                                    <!--begin::Table row-->
                                ...
                                <tbody class="text-gray-600 fw-bold">
                                    @foreach ($jobPositions as $posisi)
                                        ...
                                        <tr>
                                            ...
                                            <td> {{ $posisi->division->nama_divisi }} </td>
...
@section('custom-js')
    <script>
        ...
        var KTDatatablesButtons = function () {
            ...
            return {
                init: function () {
                    table = document.querySelector('#kt_datatable_position');
