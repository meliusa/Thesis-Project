            ...
            <div class="toolbar" id="kt_toolbar">
                ...
                <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                    ...
                    <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                        ...
                        <!--begin::Title-->
                        <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Data Divisi</h1>
                        <!--end::Title-->
                        <!--begin::Separator-->
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-dark">Divisi</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                ...
                <div id="kt_content_container" class="container-xxl">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body py-4">
                            <!--begin::Table-->
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_datatable_division">
                                <!--begin::Table head-->
                                <thead>
                                    <!--begin::Table row-->
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <form class="form-delete"
                                                    action="{{ route('division.destroy', $divisi->id) }}"
                                                    method="post">
                                                    @method('delete')
                                                    @csrf
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <form id="kt_modal_add_job_position_form" class="form"
                            action="{{ route('division.store') }}" method="POST">
                            @csrf
                            <!--begin::Scroll-->
                            <div class="d-flex flex-column scroll-y me-n7 pe-7">
                                ...
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="fw-bold fs-6 mb-2">Divisi</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
...
@section('custom-js')
    <script>
        ...
        var KTDatatablesButtons = function () {
            ...
            return {
                init: function () {
                    table = document.querySelector('#kt_datatable_division');
