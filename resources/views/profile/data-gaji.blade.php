                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-body p-9">
                        ...
                        <div class="row mb-7">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8">
                                <span class="fw-bold fs-6 text-gray-800">{{ $employee->bank }}</span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        <div class="row mb-7">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8">
                                <span class="fw-bolder fs-6 text-gray-800">{{ $employee->nomor_rekening }}</span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <div class="row mb-7">
                        ...
                        <div class="row">
                            ...
                            <div
                                ...
                                <!--begin::Action-->
                                <a href="{{ route('employee-salary.edit', $salary->id) }}"
