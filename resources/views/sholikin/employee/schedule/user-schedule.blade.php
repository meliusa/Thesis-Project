                ...
                <div id="kt_content_container" class="container-xxl">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body py-4">
                            <!--begin::Table-->
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_datatable_user_schedule">
                                <!--begin::Table head-->
                                <thead>
                                    <!--begin::Table row-->
                                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0 text-center">
                                        ...
                                        <th class="text-end min-w-30px">Aksi</th>
                                    </tr>
                                    <!--end::Table row-->
                                </thead>
                                <!--end::Table head-->
                                ...
                                <tbody class="text-gray-600 fw-bold text-center">
                                    @foreach ($employeeSchedule as $emp)
                                        <!--begin::Table row-->
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                                            <td>
                                                <b>Divisi : </b> {{ $data->division->nama_divisi }}
                                                <br>
                                                <b>Posisi : </b> {{ $data->job_position->nama_posisi }}
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-end">
                                                <a href="{{ route('user-schedule.show', $emp->id) }}"
...
@section('custom-js')
    <script>
        ...
        var KTDatatablesButtons = function () {
            ...
            return {
                init: function () {
                    table = document.querySelector('#kt_datatable_user_schedule');
