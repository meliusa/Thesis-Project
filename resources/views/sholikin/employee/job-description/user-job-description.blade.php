                ...
                <div id="kt_content_container" class="container-xxl">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body py-4">
                            <!--begin::Table-->
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_datatable_user_job_description">
                                <!--begin::Table head-->
                                <thead>
                                    <!--begin::Table row-->
...
@section('custom-js')
    <script>
        ...
        var KTDatatablesButtons = function () {
            ...
            return {
                init: function () {
                    table = document.querySelector('#kt_datatable_user_job_description');
