            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Profile {{ $user->role->nama_role }}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        <div class="card-body p-9">
                            ...
                            <div class="row">
                                ...
                                <div
                                    ...
                                    <!--begin::Action-->
                                    <a href="{{ route('superior-profile.edit', $user->id) }}"
                    ...
                    <div class="card-body pt-9 pb-0">
                        ...
                        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                            ...
                            <div class="me-7 mb-4">
                                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                    @if(Auth::user()->foto != null)
                                        <img alt="User Photo" src="{{ asset('storage/uploads/karyawan/foto-karyawan/' . Auth::user()->foto) }}" class="h-175px" />
                                    @else
                                        <img src="{{ asset('src/media/avatars/blank.png') }}" alt="user" />
                                    @endif
                                </div>
