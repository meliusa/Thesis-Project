            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('presences.index') }}" class="text-muted text-hover-primary">Daftar
                                Kehadiran</a>
                        </li>
                        <!--end::Item-->
                        <li class="breadcrumb-item">
                    ...
                    <div class="card-header border-0 pt-6">
                        <div class="card-title m-0">
                            <h3 class="fw-bolder m-0">
                                <a href="{{ route('agendas.details', $presence->agenda_id) }}"
                                    style="text-decoration: none; color: inherit;" class="text-hover-primary">
                                    Agenda : {{ $presence->agenda->topic->title }}
                                </a>
                            </h3>
                        </div>
                        <!--begin::Card title-->
