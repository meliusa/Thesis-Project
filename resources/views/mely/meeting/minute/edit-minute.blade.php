            ...
            <div id="kt_content_container" class="container-xxl">
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="collapse show">
                        <!--begin::Form-->
                        <form class="form" action="{{ route('minutes.update', $minute->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <!--begin::Card body-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <textarea name="series_of_event" class="form-control form-control-lg"
                                            ...
                                            wrap="soft">{{ $minute->series_of_event }}</textarea>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <textarea name="decision" class="form-control form-control-lg"
                                            ...
                                            data-kt-autosize="true">{{ $minute->decision }}</textarea>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <textarea name="q_n_a" class="form-control form-control-lg"
                                            placeholder="Rangkaian Acara" autocomplete="off" required rows="5"
                                            data-kt-autosize="true">{{ $minute->q_n_a }}</textarea>
                                    </div>
                                    <!--end::Col-->
                                </div>
                            </div>
