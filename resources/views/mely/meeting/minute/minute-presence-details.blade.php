        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Daftar Kehadiran Agenda</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Daftar Kehadiran Agenda</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card-header border-0 pt-6">
                        <div class="card-title m-0">
                            <h3 class="fw-bolder m-0">
                                <a href="{{ route('agendas.details', $minute->agenda_id) }}"
                                    style="text-decoration: none; color: inherit;" class="text-hover-primary">
                                    Agenda : {{ $minute->agenda->topic->title }}
                                </a>
                            </h3>
                        </div>
                        <!--begin::Card title-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_datatable_presence">
                            ...
                            <tbody class="text-gray-600 fw-bold">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $p->user->nama }} (ID Partisipan: {{ $p->user_id }})</td>
                                    <td>
                                        @php
                                        $confirmed_at = $p->confirmed_at ?
                                        \Carbon\Carbon::parse($p->confirmed_at)->format('d-m-Y H:i:s') : '';
                                        @endphp
                                        {{ $confirmed_at }}
                                    </td>
                                    <td>@php
                                        $initial_absen_at = $p->initial_absen_at ?
                                        \Carbon\Carbon::parse($p->initial_absen_at)->format('d-m-Y H:i:s') : '';
                                        @endphp
                                        {{ $initial_absen_at }}</td>
                                    <td>
                                        @php
                                        $final_absen_at = $p->final_absen_at ?
                                        \Carbon\Carbon::parse($p->final_absen_at)->format('d-m-Y H:i:s') : '';
                                        @endphp
                                        {{ $final_absen_at }}
                                    </td>
                                </tr>
