...
<section>
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Daftar Permintaan</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Daftar Permintaan</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#kt_modal_add_meeting_request">
                    ...
                    <div class="card-body py-4">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_datatable_meeting_request">
                            <!--begin::Table head-->
                            <thead>
                                <!--begin::Table row-->
                            ...
                            <tbody class="text-gray-600 fw-bold">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        <div class="badge badge-light-{{ $priorityResult }} fw-bolder">
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('meeting-requests.details', $meetingRequest->id)}}"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3 validasiupdate"
                                                    data-meetingrequest-id="{{ $meetingRequest->id }}"
                                                    data-meetingrequest-status="{{ $meetingRequest->status }}">Ubah</a>
                                                </button>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <form class="form-delete"
                                                    action="{{ route('meeting-requests.destroy', $meetingRequest->id) }}"
                                                    method="post">
                                                    @method('delete')
                                                    @csrf
                                                    <button class="menu-link px-3 btn btn-sm validasidestroy"
                                                        type="submit"
                                                        data-meetingrequest-status="{{ $meetingRequest->status }}">
                                                        Hapus
                                                    </button>
                                                </form>
                                            </div>
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3 validasiupdatestatus"
                                                    data-meetingrequest-id="{{ $meetingRequest->id }}"
                                                    data-meetingrequest-status="{{ $meetingRequest->status }}">Status</a>
                                                </button>
                                            </div>
                                            @endif
                                            <!--end::Menu item-->
    ...
    <div class="modal fade" id="kt_modal_add_meeting_request" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form id="kt_modal_add_meeting_request_form" class="form"
                        action="{{ route('meeting-requests.store') }}" method="POST">
                        @csrf
                        <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y me-n7 pe-7">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <textarea name="description" class="form-control form-control mb-3 mb-lg-0"
                                    placeholder="Deskripsi" autocomplete="off" required data-kt-autosize="true" rows="5"
                                    wrap="soft"></textarea>
                                <!--end::Textarea-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="required fw-bold fs-6 mb-2">Prioritas</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select class="form-select form-select" data-control="select2" data-placeholder=""
                                    data-allow-clear="true" data-dropdown-parent="#kt_modal_add_meeting_request_form"
                                    name="priority">
    ...
    @foreach ($meetingRequests as $meetingRequest)
    <div class="modal fade" id="kt_modal_edit_meeting_request_{{ $meetingRequest->id }}" tabindex="-1"
        aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <!--begin::Modal content-->
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form id="kt_modal_edit_meeting_request_form_{{ $meetingRequest->id }}" class="form"
                        action="{{ route('meeting-requests.update', $meetingRequest->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y me-n7 pe-7">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--begin::Input-->
                                <input type="text" name="title" class="form-control form-control mb-3 mb-lg-0"
                                    placeholder="Judul" autocomplete="off" value="{{ $meetingRequest->title }}"
                                    required />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <textarea name="description" class="form-control form-control mb-3 mb-lg-0"
                                placeholder="Deskripsi" autocomplete="off" required data-kt-autosize="true" rows="5"
                                wrap="soft">{{ $meetingRequest->description }}</textarea>
                                <!--end::Textarea-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="fv-row mb-7">
                                ...
                                <select class="form-select form-select" data-control="" data-placeholder=""
                                    data-allow-clear="true" data-dropdown-parent="#kt_modal_edit_meeting_request_form"
                                    name="priority">
                                    <option disabled>Pilih Prioritas</option>
                                    <option value="Low" {{ $meetingRequest->priority == 'Low' ? 'selected' : '' }}>Low
                                    </option>
                                    <option value="Medium"
                                        {{ $meetingRequest->priority == 'Medium' ? 'selected' : '' }}>Medium</option>
                                    <option value="High" {{ $meetingRequest->priority == 'High' ? 'selected' : '' }}>
                                        High</option>
                                </select>
                            </div>
                            <!--end::Input group-->
    ...
    @foreach ($meetingRequests as $meetingRequest)
    <div class="modal fade" id="kt_modal_edit_status_meeting_request_{{ $meetingRequest->id }}" tabindex="-1"
        aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <!--begin::Modal content-->
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form id="kt_modal_edit_status_meeting_request_form_{{ $meetingRequest->id }}" class="form"
                        action="{{ route('meeting-requests.update-status', $meetingRequest->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y me-n7 pe-7">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <select class="form-select form-select" data-control="" data-placeholder=""
                                    ...
                                    <option value="Diterima"
                                        {{ $meetingRequest->status == 'Diterima' ? 'selected' : '' }}>Diterima
                                    </option>
                                    <option value="Ditolak"
                                        {{ $meetingRequest->status == 'Ditolak' ? 'selected' : '' }}>
                                        Ditolak</option>
                                </select>
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <textarea name="rejection_reason" class="form-control form-control mb-3 mb-lg-0"
                                    ...
                                    autocomplete="off">{{ $meetingRequest->rejection_reason }}</textarea>
                                <!--end::Textarea-->
                            </div>
                            <!--end::Input group-->
                        </div>
...
<script>
    ...
    var KTDatatablesButtons = function () {
        ...
        return {
            init: function () {
                table = document.querySelector('#kt_datatable_meeting_request');
