...
<body>
    <div class="container">
        ...
        <p>Dokumentasi & notulensi rapat Anda telah mengalami perubahan status. Silakan klik tombol di bawah untuk masuk
            ke aplikasi terkait.</p>
        <div class="button">
            <a href="{{ route('doc-minutes.index') }}" target="_blank">Buka Aplikasi</a>
        </div>
