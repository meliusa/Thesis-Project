...
{   
    ...
    {      
        ...
        $user = Auth::user();
        $tipe = TipeTiket::all();
        $pengaduan = Pengaduan::where('status', '!=', 'diproses')->orderBy('nomor_tiket', 'desc')->get();
        if($r->update != null)
        {
        ...
        return view('yusyac.pengaduan-admin', compact('pengaduan', 'tipe', 'menunggu', 'diproses', 'ditolak', 'selesai', ));
    }
