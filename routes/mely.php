...
Route::middleware('auth')->group(function () {
    ...
    Route::put('meeting-participants/{id}/update-not-attending-reason', [MeetingParticipantController::class, 'updateNotAttendingReason'])->name('meeting-participants.update-not-attending-reason');
